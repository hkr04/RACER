...
# [MODIFIED] Use customized causal mask with tree attention support
...
# [MODIFIED] For compatibility with Transformers v4.52.3
...
class Qwen3VLTextAttention(nn.Module):
    ...
    # [MODIFIED] Only use SDPA attention
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        past_key_values = None  # [MODIFIED] Reset past_key_values to avoid return past_key_values.
...
class Qwen3VLTextModel(Qwen3VLPreTrainedModel):
    ...
    # [MODIFIED] Copied from modeling_qwen2_5_vl_kv.py
    def _update_causal_mask(
        ...
        # [MODIFIED] past_key_values is a list of KVCache class
        # past_seen_tokens = past_key_values.get_seq_length() if past_key_values is not None else 0
        past_seen_tokens = past_key_values[0][0].current_length.item() if past_key_values is not None else 0
